package com.harshini.jbasadmin.faculty;
...
import com.harshini.jbasadmin.R;
...
public class AddTeachers extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String [] items = new String[]{"Select Category",
                ...
                "Electronics and Communication Science Department",
                "Computer Science Department BSC",
                "Interior and Decor Design Department",
                "Information System Management Department",
                "Bachelor of Commerce Department",
                "Computer Science Department BCOM",
                "Honours Department",
                ...
                "Tourism and Travel Management Department",
                "Others"};
    ...
    private void uploadImage() {
        ...
        bitmap.compress(Bitmap.CompressFormat.JPEG,50,baso);
        byte[] finalimg = baso.toByteArray();
